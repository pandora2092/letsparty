$(document).ready(function() {
	...
	$(".link2").click(function() {
		$("html, body").animate({ scrollTop: $(".section_8").height() + 7000}, "slow");
		return false;
	});
	...
	$(".link4").click(function() {
		$("html, body").animate({ scrollTop: $(".section_2").height()+5800 }, "slow");
		return false;
	});


	$(".link5").click(function() {
		$("html, body").animate({ scrollTop: $(".section_2").height()+1000 }, "slow");
		return false;
	});

	$(".link6").click(function() {
		$("html, body").animate({ scrollTop: $(".section_2").height()+5000 }, "slow");
		return false;
	});
